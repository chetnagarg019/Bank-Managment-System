  ...
  userSchema.pre("save", async function () {
    ...
    //“User ko DB me save karne se pehle kuch kaam karna hai

    if (!this.isModified("password")) { //login krnege to pSSWORD PHLE SE hi hash hua hoga match kr jayega or agr signupr krenge to nya password aayega
